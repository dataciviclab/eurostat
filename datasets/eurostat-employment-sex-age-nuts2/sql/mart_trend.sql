-- mart_trend — Employment rate: multi-year trend and CAGR per region.
--
-- One row per (geo, unit). Reference slice only (unit PC, age Y15-64,
-- sex T).
-- NOTE: a positive CAGR means employment is RISING (better).
