-- mart_geo_benchmark — Employment rate by NUTS2 region: EU27-wide
-- benchmark analytics.
--
-- One row per (year, geo, unit, age, sex). EU27-wide comparative analytics:
...
-- unit = 'PC' AND age = 'Y15-64'  AND sex = 'T'
...
SELECT
    ...
    CASE
        WHEN b.unit = 'PC' AND b.age = 'Y15-64' AND b.sex = 'T'
    ...
    CASE
        WHEN b.unit = 'PC' AND b.age = 'Y15-64' AND b.sex = 'T' AND b.is_eu
        THEN ROUND(
