-- mart_trend — Population density: multi-year trend and CAGR per region.
--
-- One row per (geo, unit). Reference unit PER_KM2. Series starts 1990.
-- NOTE: a positive CAGR means density is RISING (population growth).
