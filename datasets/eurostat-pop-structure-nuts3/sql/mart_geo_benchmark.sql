-- mart_geo_benchmark — Population structure (old-age dependency) by NUTS3
-- region: EU27-wide benchmark
-- analytics.
--
...
-- unit = 'PC' AND indic_de = 'OLDDEP2' (old-age dependency ratio — the
...
SELECT
    ...
    CASE
        WHEN b.unit = 'PC' AND b.indic_de = 'OLDDEP2'
    ...
    CASE
        WHEN b.unit = 'PC' AND b.indic_de = 'OLDDEP2' AND b.is_eu
        THEN ROUND(
