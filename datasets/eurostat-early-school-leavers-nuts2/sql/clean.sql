-- clean.sql: EDAT_LFSE_16 — early school leavers by NUTS2 region, enriched.
--
-- Extra dimensions vs the base pattern: sex (M/F/T) and age (Y18-24).
-- Their labels are simple code mappings (no dedicated codelist) — kept
-- inline via CASE. freq/unit/flag come from `support:` codelists.
--
...
-- Aggregated geographies get NULL so they never pollute benchmarks.
--
-- NOTE: higher value = worse (higher early leaving share, unit PC).
