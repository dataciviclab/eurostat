-- clean.sql: DEMO_R_PJANGRP3 — population by age group, sex and NUTS3
-- region, enriched.
--
-- Extra dimensions vs the base pattern: sex (M/F/T) and age (age group).
-- Sex labels are simple code mappings (inline CASE); age label is the
-- raw code (Y05-09, Y10-14, TOTAL, ...).
--
...
--
-- NOTE: slice benchmark = sex T + age TOTAL (total population, unit NR).
