-- clean.sql: RD_E_GERDREG — spesa R&D per settore e regione NUTS2
SELECT
    r.freq,
    r.sectperf,
    r.unit,
...
LEFT JOIN read_csv('codelists/sectperf.csv', auto_detect=true, delim=',', header=true) sp ON r.sectperf = sp.code
