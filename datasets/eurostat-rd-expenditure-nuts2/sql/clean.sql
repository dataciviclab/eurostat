-- clean.sql: RD_E_GERDREG — R&D expenditure (GERD) by NUTS2 region, enriched.
--
-- Extra dimension vs the base pattern: sectperf (sector of performance),
...
--
-- NOTE: PC_GDP = R&D expenditure as % of GDP — higher value = more
...
SELECT
    ...
    sp.label_en AS sectperf_label_en,
...
LEFT JOIN read_parquet('{support.sectperf.path}') sp ON r.sectperf = sp.code
