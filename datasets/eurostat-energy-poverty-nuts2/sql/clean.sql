-- clean.sql: ILC_MDES01_R — inability to keep home adequately warm by NUTS2,
-- enriched (energy poverty).
--
...
--
-- NOTE: higher value = worse (higher share of population unable to heat home,
-- unit PC).
