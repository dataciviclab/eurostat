-- clean.sql: CRIM_GEN_REG — police-recorded offences by NUTS3 region, enriched.
--
-- Extra dimension vs the standard pattern: `iccs` (crime category), enriched
-- with label from the ICCS codelist.
--
...
LEFT JOIN read_csv('codelists/iccs.csv', auto_detect=true, delim=',', header=true) i ON r.iccs = i.code
