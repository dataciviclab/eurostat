-- clean.sql: NAMA_10R_3NLP — produttività nominale del lavoro + codelist na_item
SELECT
    r.freq,
    r.na_item,
    r.unit,
...
LEFT JOIN read_csv('codelists/na_item.csv', auto_detect=true, delim=',', header=true) nai ON r.na_item = nai.code
