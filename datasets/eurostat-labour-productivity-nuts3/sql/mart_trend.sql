-- mart_trend — Labour productivity: multi-year trend and CAGR per region.
--
-- One row per (geo, unit). Reference slice only (unit EUR, na_item NLPR_PER).
-- NOTE: a positive CAGR means productivity is RISING (good).
