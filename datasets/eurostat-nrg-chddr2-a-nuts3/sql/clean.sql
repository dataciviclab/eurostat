-- clean.sql: NRG_CHDDR2_A — cooling and heating degree days by NUTS3 region,
-- enriched.
--
-- Extra dimension vs the base pattern: indic_nrg (HDD heating / CDD cooling
-- degree days), enriched with label from the support codelist.
--
...
--
-- NOTE: HDD = heating degree days (climate severity indicator).
