-- clean.sql: auto-generated for freq, landuse, unit, geo
SELECT
    r.freq,
    r.landuse,
    r.unit,
    ...
    lu.label_en AS landuse_label_en,
...
LEFT JOIN read_csv('codelists/landuse.csv', auto_detect=true, delim=',', header=true) lu ON r.landuse = lu.code
