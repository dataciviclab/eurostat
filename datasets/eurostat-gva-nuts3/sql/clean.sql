-- clean.sql: NAMA_10R_3GVA — gross value added by NUTS3 region, enriched.
--
-- Extra dimension vs the base pattern: nace_r2 (NACE sector), enriched
-- with label from the support codelist.
--
...
--
-- NOTE: CP_MEUR = gross value added in current prices (million EUR).
