...
SELECT
    ...
    lev.label_en AS levels_label_en,
...
LEFT JOIN read_csv('codelists/levels.csv', auto_detect=true, delim=',', header=true) lev ON r.levels = lev.code
LEFT JOIN read_csv('codelists/clc18.csv', auto_detect=true, delim=',', header=true) c ON r.clc18 = c.code
